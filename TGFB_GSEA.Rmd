...
```{r load EF lists}
## loading EWS::FLI1 gene sets. This uses Neerja's code for reading a custom GMT file she made. Also below in the ECM section there is an easier way to read an excel CSV that you have put your own custom gene lists into
